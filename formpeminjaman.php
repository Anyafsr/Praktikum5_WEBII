...
<body>
    ...
    <form action="" method="post">
        <table>
            ...
            <tr>
                <td>Nama Member</td>
                <td><input type="text" name="nama_member" <?php echo (isset($_GET['id_peminjaman'])) ?  "value = " . $result[0]["nama_member"] . "" : "value = '' "; ?> required> <br></td>
            </tr>
            <tr>
                <td>Judul Buku</td>
                <td><input type="text" name="judul_buku" <?php echo (isset($_GET['id_peminjaman'])) ?  "value = " . $result[0]["judul_buku"] . "" : "value = '' "; ?> required> <br></td>
            </tr>
    ...
    if (isset($_POST['submit'])) {
        tambahpeminjaman($_POST['id_Peminjaman'],$_POST['nama_member'],$_POST['judul_buku'],$_POST['pinjam'],$_POST['kembali']);
    }
    if (isset($_POST['update'])) {
       updatepeminjaman($_POST['id_Peminjaman'],$_POST['nama_member'],$_POST['judul_buku'],$_POST['pinjam'],$_POST['kembali']);
    }
    ?>
</body>
</html>